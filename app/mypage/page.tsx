    ...
    <div className="pt-6 pb-16 animate-in">
      <div className="flex items-center justify-between mb-5 flex-wrap gap-3">
        ...
        <div className="flex items-center gap-3">
          <div className="px-4 py-2 rounded-lg border" style={{background:'var(--accent-bg)',borderColor:'var(--accent-border)'}}><span className="text-xs" style={{color:'var(--text-muted)'}}>크레딧</span><span className="ml-2 text-lg font-bold" style={{color:'var(--accent)'}}>◆ {credits}</span></div>
