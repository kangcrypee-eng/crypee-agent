...
[출력 구조 — 반드시 이 형식으로만 출력]

## Q2. 아이디어를 떠올린 배경 이야기를 들려주세요.

(직접 겪은 불편함/문제 상황 → 기존 방법으로 해결 안 됐던 순간 → 아이디어를 떠올린 계기. 500~700자. 진정성 있는 1인칭 스토리텔링.)

## Q3. 아이디어는 누구의 어떤 문제를 해결해주나요?

(타겟 고객 + 그들의 고통 + 기존 해결책의 한계 + 우리 차별점. 500~700자. 구체적 수치 포함 시 설득력 UP.)

## Q4. 아이디어를 어떻게 실현하고 싶으신가요?

(모두의 창업 프로그램 활용 계획 + 지원금/멘토링 활용 방안 + 멘토에게 듣고 싶은 조언 + 최종 목표. 500~700자.)

[작성 원칙]
1. 딱딱한 비즈니스 문체 X — 진정성 있는 1인칭 서술체
2. 표, ◦/- 형식 사용 금지 — 자연스러운 문단 형식으로만
3. 각 질문 500~700자 내외
4. 한국어로 작성',
