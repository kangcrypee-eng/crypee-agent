export const MODEL_PRICING = {
  'claude-haiku-4-5': { input: 1.00, output: 5.00, label: 'Haiku 4.5', desc: '빠르고 저렴. 단순 문서용' },
  'claude-sonnet-4-6': { input: 3.00, output: 15.00, label: 'Sonnet 4.6', desc: '균형. 중간 복잡도' },
  'claude-opus-4-6': { input: 5.00, output: 25.00, label: 'Opus 4.6', desc: '최고 품질. 고복잡도' },
} as const
